      ...
      <div class="home page">
          ...
          <div class="game-select">
              <select id="gameSelect">
                  ...
                  <option value="amiibo-festival-sunny" selected data-i18n="AC: Amiibo Festival (Wii U) [Sunny]"></option>
                  <option value="amiibo-festival-rainy" selected data-i18n="AC: Amiibo Festival (Wii U) [Rainy]"></option>
                  <option value="amiibo-festival-snowy" selected data-i18n="AC: Amiibo Festival (Wii U) [Snowy]"></option>
